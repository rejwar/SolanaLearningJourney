...
//     let accounts_iter = &mut accounts.iter();
//     let target_account = next_account_info(accounts_iter)?;
//     let account_pubkey = target_account.lamports();
...
//     let target_account = next_account_info(accounts_iter)?;
//     let account_pubkey = target_account.key;
//     let lamports = target_account.key;
//     let lamports = target_account.lamports();
//     let sol_balance = lamports as f64 / 1_000_000_000;
//     if target_account.owner = &system_program::ID {
//         msg! {"Target == system"}
...
// ) -> ProgramResult {
//     let accounts_iter = &mut accounts.iter();
//     let target_account = next_account_info.key;
//     let lamports = target_account.lamports();
//     let sol_balance = lamports as f64 / 1_000_000_000;
//     if target_account.owner == &system_program::ID {
//         msg! {target == system}
...
// use solana_program::{
//     account_info::{self, next_account_info, next_account_infos, AccountInfo},
